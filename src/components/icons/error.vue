<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#db4b32" height="45px" width="45px" version="1.1" id="Capa_1" viewBox="0 0 27.963 27.963" xml:space="preserve" style="float: left">
